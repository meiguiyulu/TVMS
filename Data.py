...
class DataLayer(data.Dataset):
    def __init__(self, current_fold, low_range, high_range, slice_threshold, slice_thickness, organ_ID, plane):
        ...
        self.image_filename = ['' for _ in range(self.slices)]
        self.label_filename = ['' for _ in range(self.slices)]
